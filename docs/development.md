...
1. Update version: `./scripts/version.sh set 1.1.3`
2. Commit changes: `git add . && git commit -m "release: version 1.1.3"`
3. Create tag: `git tag v1.1.3`
